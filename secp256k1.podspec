...
Bitcoin, Ethereum and many other Cryptocurrency Signature generation and verification.
  ...
  s.homepage         = 'https://github.com/status-im/secp256k1.swift'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Koray Koska' => 'koray@koska.at' }
  s.source           = { :git => 'https://github.com/status-im/secp256k1.swift.git', :tag => s.version.to_s, :submodules => true }
  ...
  s.pod_target_xcconfig = {
    ...
    'HEADER_SEARCH_PATHS' => '"${PODS_TARGET_SRCROOT}/secp256k1/Classes/secp256k1"'
  }

  s.source_files = 'secp256k1/Classes/secp256k1.swift', 'secp256k1/Classes/secp256k1/{src,include}/*.{h,c}', 'secp256k1/Classes/secp256k1/src/modules/{recovery,ecdh}/*.{h,c}', 'secp256k1/Classes/*.{h,c}'
  s.public_header_files = 'secp256k1/Classes/secp256k1/include/*.h'
  s.private_header_files = 'secp256k1/Classes/secp256k1_ec_mult_static_context.h', 'secp256k1/Classes/secp256k1/*.h', 'secp256k1/Classes/secp256k1/src/*.h', 'secp256k1/Classes/secp256k1/src/modules/{recovery, ecdh}/*.h'
